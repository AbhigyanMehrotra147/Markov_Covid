...
class Global_icu_patients(fff):
    ...
    def Filter_Column(self):
        ...
        self.Data_frame = self.Data_frame[['location', 'icu_patients']]
    ...
    def Make_new_data_fram(self):
        ...
        for country in self.Grouped_location_data_frame:
            ...
            self.Merged_data_frame[country_name] = country[1]['icu_patients']
    ...
    def Plot_data_frame(self):
        ...
        plt.title("Dynamic Gloabal maximum Normalized icu patients to each country")
        plt.xlabel('Date')
        plt.ylabel(
