...
class Global_new_cases(fff):
    ...
    def Filter_Column(self):
        ...
        self.Data_frame = self.Data_frame[['location', 'new_cases']]
    ...
    def Make_new_data_fram(self):
        ...
        for country in self.Grouped_location_data_frame:
            ...
            self.Merged_data_frame[country_name] = country[1]['new_cases']
    ...
    def Plot_data_frame(self):
        ...
        plt.title("Dynamic Gloabal maximum Normalized cases to each country")
        plt.xlabel('Date')
        plt.ylabel(
